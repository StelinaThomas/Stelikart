...
public class DBConfig 
{
	...
	//	dataSource.setUrl("jdbc:h2:tcp://localhost/~/S190126");
		dataSource.setUrl("jdbc:h2:file:C:/temp/test");
	...
	public SessionFactory getSessionFactory()
	{
		...
		System.out.println("==========Data Source before LocalSessionFactoryBuilder==============");
		LocalSessionFactoryBuilder factory=new LocalSessionFactoryBuilder(this.getH2DataSource());
		System.out.println("==========Data Source after LocalSessionFactoryBuilder==============");
